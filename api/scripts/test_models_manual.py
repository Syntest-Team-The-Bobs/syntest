...
def test_manual():
    ...
    with app.app_context():
        ...
        print(
            f"   ✓ Stimulus has {retrieved_stimulus.test_data_entries.count()} test data entry(ies)"
        )
        print(
            f"   ✓ Stimulus has {retrieved_stimulus.analyzed_data_entries.count()} analyzed data entry(ies)"
        )
