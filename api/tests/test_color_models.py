...
class TestColorTrial:
    ...
    def test_selected_hex_color(self, db_session):
        ...
        trial = ColorTrial(
            participant_id="P123", selected_r=255, selected_g=128, selected_b=64
        )
        db_session.add(trial)
        db_session.commit()
...
class TestTestData:
    ...
    def test_consistency_score_calculation(self, db_session):
        ...
        test_data = TestData(
            user_id="P123", test_type="CCT", cct_mean=100.0, cct_std=10.0
        )
        db_session.add(test_data)
        db_session.commit()
    ...
    def test_consistency_score_none(self, db_session):
        ...
        test_data = TestData(user_id="P123", test_type="CCT")
        db_session.add(test_data)
        db_session.commit()
