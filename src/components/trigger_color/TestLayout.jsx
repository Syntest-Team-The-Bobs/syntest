	...
	return (
		<div style={{ minHeight: "100vh", backgroundColor: "#f9fafb" }}>
			...
			>
				...
				>
					You'll assign a color to each <strong>{testType}</strong>.{" "}
					<strong>Click and hold</strong> the mouse on the wheel and{" "}
					<strong>drag</strong> to preview and adjust a color. To record a
					choice, <strong>click to lock</strong> it — the lock icon appears when
					locked — and click again to unlock if you need to change it. Press{" "}
					<strong>Next</strong> to save each choice. For best results, use a
					laptop/desktop and turn off blue-light filters.
				</p>
