...
export default function ColorWheel({ 
  ...
  function colorAt(e) {
    ...
    const x = Math.min(Math.max(0, (e.clientX - rect.left) * c.width / rect.width), c.width - 1);
    const y = Math.min(Math.max(0, (e.clientY - rect.top) * c.height / rect.height), c.height - 1);
