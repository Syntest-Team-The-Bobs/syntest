 ...
 * - For music tests: shows a play button instead of text
 */
export default function StimulusDisplay({ stimulus, testType, getFontSize, onReplay }) {
  // Music test: show play button
  if (testType === 'music' && onReplay) {
    return (
      <div style={{ 
        textAlign: "left", 
        minHeight: "120px", 
  ...
  // Text-based tests: show the stimulus text (original behavior)
  return (
    <div style={{ 
      textAlign: "left", 
      minHeight: "120px", 
