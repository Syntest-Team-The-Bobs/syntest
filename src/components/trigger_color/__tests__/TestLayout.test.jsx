...
vi.mock("../TestProgress", () => ({
	default: ({ stimulus, currentTrial, progressInTrial, itemsPerTrial }) => (
		<div data-testid="progress">
			{stimulus} - Trial {currentTrial} -{" "}
			{progressInTrial !== undefined ? progressInTrial : ""}/
			{itemsPerTrial !== undefined ? itemsPerTrial : ""}
		</div>
	),
}));
...
describe("TestLayout", () => {
	...
	describe("Stimulus Display", () => {
		...
		it("shows MusicPlayButton for music tests with onReplay", () => {
			...
			render(
				<TestLayout {...baseProps} testType="music" onReplay={onReplay} />,
			);
	...
	describe("No Experience Checkbox", () => {
		...
		it("shows letter-specific helper text", () => {
			...
			expect(
				screen.getByText(
					/don't experience any color association with this letter/i,
				),
			).toBeTruthy();
		});
		...
		it("shows music-specific helper text", () => {
			...
			expect(
				screen.getByText(
					/don't experience any color association with this music/i,
				),
			).toBeTruthy();
		});
	});
