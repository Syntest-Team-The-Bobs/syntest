...
import { buildLetterDecks } from "../../services/deck";
...
const LETTER_CONFIG = {
	...
	description:
		"In this test, you will see letters one at a time. For each letter, select the color you most strongly associate with it.",
	instructions: [
