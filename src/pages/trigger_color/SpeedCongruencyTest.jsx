...
<<<<<<< HEAD
	...
	if (phase === "intro") {
		return (
			<div style={pageStyle}>
				<Card style={cardStyle} title={title}>
					<p style={{ marginBottom: "10px", fontSize: "1.15rem" }}>
	...
	if (phase === "stimulus") {
		...
		const displayedColorStim = expectedOptionStim
			? expectedOptionStim.color
			: "#000000";
		...
		return (
			<div style={pageStyle}>
				<Card
					style={{ ...cardStyle, backgroundColor: cardBgStim }}
					title={title}
				>
					<div
						style={{
							...triggerBoxStyle,
							color: displayedColorStim,
					...
					<p
						style={{
							marginTop: "16px",
							color: cardTextColorStim === "#000" ? "#777" : "#ddd",
							fontSize: "1.15rem",
						}}
					>
						{currentTrial.stimulus
							? `Playing sound — plays remaining: ${countdown}`
					...
					<p
						style={{
							marginTop: "8px",
							fontSize: "0.95rem",
							color: cardTextColorStim === "#000" ? "#999" : "#ccc",
						}}
					>
	...
	return (
		<div style={choicePageStyle}>
			<Card style={{ ...cardStyle, backgroundColor: cardBg }} title={title}>
				<h2 style={{ fontSize: "1.25rem", color: cardTextColor }}>
					Speed Congruency
				</h2>
				<p style={{ fontSize: "1.15rem", color: cardTextColor }}>
					Does this colour match your automatic association for the trigger?
				</p>
				...
				{errorMessage && (
					<p
						style={{
							marginTop: 12,
							color: cardTextColor === "#000" ? "#b00020" : "#ff6b6b",
						}}
					>
						{errorMessage}
					</p>
