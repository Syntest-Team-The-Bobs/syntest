...
import { buildWordDecks } from "../../services/deck";
...
const WORD_CONFIG = {
	...
	description:
		"In this test, you will see words one at a time. For each word, select the color you most strongly associate with it.",
	instructions: [
